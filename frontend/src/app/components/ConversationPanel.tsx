...
export function ConversationPanel({ messages, onSendMessage, isConnected }: ConversationPanelProps) {
  ...
  return (
    ...
    >
      ...
      <div
        ref={scrollRef}
        className="flex-1 p-6 overflow-y-auto space-y-4 scroll-smooth [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-gray-400"
      >
        {messages.length === 0 ? (
          <motion.div
